...
* Où se situe le (ou les) point(s) le(s) plus chaud(s)? (La question porte sur la localisation spatio-temporelle du ou des points)
...
Pour pouvoir faire tout ce travail, nous allons utiliser différents couches d'objet matricielles qui seront sous forme d'objet `rasterStack` qui seront l'objet des principaux objectifs d'apprentissage de cette section.
...
Nous allons maintenant répondre au 
...
#### Où se situe le (ou les) point(s) le(s) plus chaud(s)?
...
Pour finir, nous allons animer en présentant construisant les donn.es.
