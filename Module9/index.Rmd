...
Pour réaliser des profiles de températures, nous allons dans pour, nous allons réutiliser l'objet `megantic_buf`
...
par(mfrow = c(3, 1))
plot(getZ(mint), profile(mint, megantic_buf), type = "l")
plot(getZ(mint), profile(maxt, megantic_buf), type = "l")
