...
Notez que la fonction `apply()` calcule le maximum pour chacune des couches contenues dans `maxt_megantic`, alors que le fonction `which.max()` détermine l'indice la couche qui contient le maximum de ces maxima. 
