...
Finalement, nous utilisons la fonction `saveGIF()` de la bibliothèque `animation`, pour enregistrer une séquence de figures produites avec `plot_profil()` en faisant évoluer le nombre de mois&nbsp;: 
...
```{r, eval = FALSE}
saveGIF(anim_carte(mint_region, 12), movie.name = "anim_mint.gif", ani.height = 500, ani.width = 500)
```
