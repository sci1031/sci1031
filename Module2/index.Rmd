...
<br>
```{r multipoints, fig.align='left', echo=FALSE,fig.cap="L’emplacement des stations de vélo en libre partage, *Bixi*, dans un quartier de Montréal correspond à une géométrie multipoints. Source : https://secure.bixi.com/map/ [taille réelle](Module2/images/2_multipoints.PNG)", out.width = '60%'}
