...
Pour répondre à notre question, nous devons résoudre sont les suivantes:
...
La seconde étape consiste à lire le fichier *shapefile* de l'ensemble des villes du Québec en utilisant la fonction `st_read()` tel que vu dans le [module 2](#lire-shp).
