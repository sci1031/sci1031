...
Afin de faciliter le téléchargement de ces données, l'ensemble de ces couches d'informations spatiales peuvent être téléchargées en cliquant sur un seul lien: [données pour le module 7](https://github.com/sci1031/sci1031/raw/master/Module7/Module7_donnees.zip). 
...
reg_tourist <- st_read("Module7/Module7_donnees/regions_touristiques/Shapefile/regn_tours_s250k_20160125.shp")
