...
La première étape consiste à charger les bibliothèques requises pour lire les données spatiales vectorielles (`sf`) et les visualiser (`mapview`). 
...
<!--  À arranger: Pu sur que ce soit necessaire  -->
...
<!-- À arranger: ramener texte d'en haut  Pu sur que ce soit necessaire-->
