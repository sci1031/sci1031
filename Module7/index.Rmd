...
```{r}
id_buffer_sherbrooke <- which(top10_villes_buffer$toponyme == 'Saint-Jean-sur-Richelieu')
```
...
# La fonction lengths retourne la dimension des vecteurs (c.a.d le nombre de
# parcs) pour chacune des niveaux de la liste (chaque niveau étant une zone tampon).
```
...
Pour le module 8, nous nous attarderons aux 4 parcs de la région de Sherbooke afin de dresser un portrait des sentiers hivernaux et trouver les meilleurs panoramas de la région.
