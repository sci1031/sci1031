...
=======
chemin <-"D:/votrechemin/SCI1031/Moattributsdule4/Donnees/"
nom_du_fichier<- paste(chemin, "/Montreal_Velo/pistes/pistes_cyclables_type.shp", sep = "")
>>>>>>> Stashed changes
...
Vous allez maintenant apprendre à visualer des données *shapefile* en utilisant la fonction `mapview()` de la librairie `mapview`. Cette librarie est une des plus simples à utiliser pour visualiser rapidement des données spatiales. Commençons par charger cette librarie dans la console `R`:
