...
```{r plotgeo, eval = TRUE, echo = FALSE, fig.height=10, fig.width = 10,fig.show='hold',fig.align='center', dev = 'png', fig.cap = "Géométries multipoint, ligne et polygone crées avec les fonctions `st_multipoint()`,`st_linestring()`, et `st_polygon()` respectivement."}
...
```{r plot-terre2, echo = TRUE,  warning = FALSE, message = FALSE, eval = TRUE, dev = 'png', fig.height=6, fig.width = 10,fig.show='hold',fig.align='center'}
...
```{r plot-terre3, echo = TRUE,  warning = FALSE, message = FALSE, eval = TRUE, dev = 'png', fig.height=6, fig.width = 10,fig.show='hold',fig.align='center', fig.cap="Limites terrestres de l'île de Montréal selon les projections Web Mercartor (gauche), Mercator (centre) et Robinson (droit)"}
