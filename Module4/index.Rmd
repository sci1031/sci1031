...
>
> - Créer un *shapefile* et comprendre sa structure.
...
Nous avons appris à la [leçon 2](#base) que les données vectorielles peuvent prendre différentes géométries (point, ligne, polygone, etc.). La bibliothèque `sf` possède des fonctions pour créer ces géométries simples, c'est-à-dire pour créer des objects de la classe `sfg` (*simple feature geometry*).
...
points_attribut <- data.frame(
  ...
  nombre_eleve = c(403, 357, 280, 296),
