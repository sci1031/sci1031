...
```{r plot-voie2, warning = FALSE, message = FALSE, eval = FALSE, fig.cap="Bandes cyclables sur l'île de Montréal"}
...
map_mercator <- mapview(limites_terrestres, col.regions = "ùwhite")
