...
Le fichier `nz_capitales.csv` contient les coordonnées géographiques des capitales des régions administratives de la Nouvelle-Zélande; nous l'utiliserons à la section [exercice](#ex_vec) à la fin de ce module. 
...
```{r plotgeo, eval = TRUE, echo = FALSE, fig.height=10, fig.width = 10,fig.show='hold',fig.align='center', fig.cap = "Géométries multipoint, ligne et polygone crées avec les fonctions `st_multipoint()`,`st_linestring()`, et `st_polygon()` respectivement."}
...
```{r plotgeo2, eval = FALSE, echo = FALSE, fig.cap = "Géométries multipoint, ligne et polygone crées avec les fonctions `st_multipoint()`,`st_linestring()`, et `st_polygon()` respectivement."}
...
```{r  plot-viridis, echo = FALSE,  warning = FALSE, message = FALSE, eval = TRUE, fig.height=0.2, fig.width = 10, fig.show='hold', fig.align='center', fig.cap="Palette viridis contenant 20 couleurs différentes"}
library(viridis)
library(munsell)
library(colorspace)
...
```{r plot-terre2, echo = TRUE,  warning = FALSE, message = FALSE, eval = TRUE, fig.height=6, fig.width = 10,fig.show='hold',fig.align='center'}
...
```{r plot-terre3, echo = TRUE,  warning = FALSE, message = FALSE, eval = TRUE, fig.height=6, fig.width = 10,fig.show='hold',fig.align='center', fig.cap="Limites terrestres de l'île de Montréal selon les projections Web Mercartor (gauche), Mercator (centre) et Robinson (droit)"}
...
```{r plot-ecoles-pub-mtl-cs, echo = TRUE,  warning = FALSE, message = FALSE, eval = TRUE, fig.cap="Les écoles publiques de la ville de Montréal par type de commissions scolaires."}
...
```{r plot-ecoles-pub-mtl-ens, echo = TRUE,  warning = FALSE, message = FALSE, eval = TRUE, fig.cap="Les écoles publiques de la ville de Montréal selon le niveau d'enseignement."}
