...
<br>
```{r rstudio, fig.align='left', echo=FALSE, fig.link='Module1/images/1_rstudio.png', fig.cap="Interface RStudio. Source : @Douglas_IntroR_2022 An introduction to R: [RStudio orientation](https://intro2r.com/rstudio_orient.html).", out.width = '50%'}
knitr::include_graphics('Module1/images/1_rstudio.png')
```
<br>
...
<br>
```{r rscript, fig.align='left', echo=FALSE, fig.link='Module1/images/1_new_script.png', fig.cap="Créer un fichier R. Source : @Douglas_IntroR_2022 An introduction to R: [RStudio orientation](https://intro2r.com/rstudio_orient.html).", out.width = '50%'}
knitr::include_graphics('Module1/images/1_new_script.png')
```
<br>
...
<br>
```{r runscript, fig.align='left', echo=FALSE, fig.link='Module1/images/1_rstudio_run.png', fig.cap="Utiliser un fichier R. Source : @Douglas_IntroR_2022 An introduction to R: [RStudio orientation](https://intro2r.com/rstudio_orient.html).", out.width = '50%'}
...
```{r rscal_vec, fig.align='left', echo=FALSE, fig.link='Module1/images/1_scal_vec.png', fig.cap="Représentation d'un scalaire et d'un vecteur. Source : @Douglas_IntroR_2022 An introduction to R: [Data structures](https://intro2r.com/data-structures.html).", out.width = '50%'}
...
```{r rmat_arr, fig.align='left', echo=FALSE, fig.link='Module1/images/1_mat_array.png', fig.cap="Représentation d'un scalaire et d'un vecteur. Source : @Douglas_IntroR_2022 An introduction to R: [Data structures](https://intro2r.com/data-structures.html).", out.width = '50%'}
