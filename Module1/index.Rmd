...
Dans cette section, vous réviserez les commandes de base en `R`^[Le contenu de cette section est tiré, entre autres, du livre [An Introduction to R](https://intro2r.com/) [@Douglas_IntroR_2022]. Le reste du cours est dédié à l'apprentissage des bibliothèques et des fonctions pour manipuler, visualiser et analyser des données spatiales. Il est donc important de vous assurer de posséder les acquis de base en `R` pour poursuivre votre apprentissage vers des notions plus complexes.
...
<br>
```{r rstudio, fig.align='left', echo=FALSE, fig.link='Module1/images/1_rstudio.png', fig.cap="Interface RStudio. Source : @Douglas_IntroR_2022", out.width = '50%'}
...
<br>
```{r rscript, fig.align='left', echo=FALSE, fig.link='Module1/images/1_new_script.png', fig.cap="Créer un fichier R. Source : @Douglas_IntroR_2022", out.width = '50%'}
...
<br>
```{r runscript, fig.align='left', echo=FALSE, fig.link='Module1/images/1_rstudio_run.png', fig.cap="Utiliser un fichier R. Source : @Douglas_IntroR_2022", out.width = '50%'}
...
Le répertoire de travail (*working directory* en anglais) est le dossier par défaut dans lequel R cherche les fichiers que vous téléchargerez au cours de votre session et inscrit tout fichier que vous sauvegarderez. 
