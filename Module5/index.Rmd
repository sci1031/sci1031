...
En fait, ces données utilisent la projection Québec Lambert, qui est appropriée pour représenter des données à l'échelle de la province. Celle-ci est basée sur le datum NAD83 qui être très proche du datum WGS84.   


Retournez voir le [Module 2](#SRC) pour un rappel des systèmes de coordonnées de référence!
...
```{r, fig.cap="Rasters de projections Québec Lamberet et MTM"}
par(mfrow=c(1,2))
