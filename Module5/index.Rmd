...
summary(G)
```
En plus du minimum, du maximum, et de la médiane, nous obtenons aussi le premier et le troisième quantile, ainsi que le nombre de cellules de valeur `NA` contenu dans le raster.
