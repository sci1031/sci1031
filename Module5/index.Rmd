...
M_logique <- raster(nrows=8, ncols=8, xmn = 0, xmx = 4, ymn = 0, ymx = 4, 
    vals = z_mult3, crs = CRS("+proj=longlat +datum=WGS84"))
...
```{r, fig.dim = c(5, 5), fig.cap="Raster dont les valeurs sont de type logique"}
mp_ml <- mapview(stars::st_as_stars(M_logique))
mp_ml@map
```
<br>
