...
tm_shape(V) +
  tm_symbols(size = 0.5, hover = "Mncplts")
```
...
En utilisant les données `land`, produire une carte interactive de la couverture terrestre simplifiée (`cover_cls`). N'oubliez pas de revenir au mode statique à la fin.
