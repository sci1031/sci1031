...
Téléchargez les [données sur le réseau de pistes cyclables](https://github.com/elisefilotas/Donnees_spatiales/blob/master/Montreal_Velo.zip). Sauvegardez le dossier compressé (`zip`) dans votre répertoire de travail `Donnees` pour ce module, et dézippez-le. Le dossier Montreal_Velo comprend trois sous-dossiers:
