...
Pour explorer d'autres exemples, regarder ce [site](http://www.suluclac.com/Wiki+MathJax+Syntax), ou [celui-ci](https://en.wikibooks.org/wiki/LaTeX/Mathematics) pour des informations plus complètes.
...
La création facilitée de tableaux est l'une des extensions bien utile de Pandoc Markdown. Il existe plusieurs extensions pour faire des tableaux. Pour plus d'information, nous vous recommandons la [page écrite par Jean-Daniel Bonjour](http://enacit1.epfl.ch/markdown-pandoc/#tableaux) sur ce sujet. 
