...
et voilà le lien vers la page [Markdown](https://fr.wikipedia.org/wiki/Markdown) de Wikipedia.
...
Nous obtenons donc un code R dans un environnement adéquate (voir la coloration
...
Nous savons maintenant que l'utiliation des options `echo =
...
Dans un premier temps, télécharger le dossier [Module3_donnees.zip](https://github.com/sci1031/data/raw/main/Module3_donnees.zip) dans votre répertoire de travail pour ce module, et dézippez-le. Le dossier contient trois fichiers:
