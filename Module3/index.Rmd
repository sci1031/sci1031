...
- Certains symboles sont réservés au formatage du texte. Il s'agit des symboles \\, \&, \#, \$ et \[. Lorsque leur affichage est requis, c'est-à-dire lorsque nous désirons les utiliser dans notre texte, nous devons les faire précéder du caractère d'échappement qui est, pour Markdown, l'antislash&nbsp;: "\\". Par exemple, nous devons entrer &nbsp;:
...
Pour créer une liste numérotée, il suffit de numéroté chaque élément de la liste. Par exemple: 
