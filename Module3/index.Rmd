...
```{r evolution, fig.align='left', echo=FALSE, fig.cap="Évolution des modèles de la forme de la Terre : un corps plat, une sphère, une ellipsoïde et un géoïde. [*Voir image taille réelle*.](./Module3/images/3_evolution.png)", out.width = '80%'}
