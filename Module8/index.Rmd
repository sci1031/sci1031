...
La fonction `merge()` de la bibliothèque `raster` permet de combiner deux *rasters* ou plus. En guise d'exemple, combinons les *rasters* `dem_ma` et `dem_ma_inv` créés plus haut en applicant la fonction `mask()` au *raster* `dem`&nbsp;: 
