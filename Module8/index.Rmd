...
>
>i. `st_cast(rando, "POINT")` décompose le MULTILINESTRING `rando` en ses vertex successifs, retournés dans l’ordre dans lequel ils définissent la géométrie. L’ordre de traversée du sentier est ainsi préservé dans `rando_pts`.
>
