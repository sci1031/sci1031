...
>
>i. `st_cast(rando_sections, "POINT")` décompose les géométries de ligne de `rando_sections` en leurs vertex successifs, retournés dans leur ordre d’apparition le long de chaque section. La concaténation de toutes les sections dans `rando_pts` préserve ainsi l’ordre de traversée du sentier de bout en bout.
>
